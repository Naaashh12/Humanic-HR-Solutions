  ...
  return (
    <div className="min-h-screen bg-black pt-20">
      ...
      <div className="container-custom py-16">
        <h2 className="text-4xl font-bold font-bebas text-[#e6eaed] mb-12">Why Work With Us</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                className="p-6 border border-[#8c0415] hover:border-[#bf0614] bg-black/50 transition-all duration-300"
                whileHover={{ y: -5 }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: idx * 0.1 }}
              >
                <Icon className="w-8 h-8 text-[#bf0614] mb-4" />
      ...
      {/* Open Positions */}
      <div className="container-custom py-16 border-t border-[#8c0415]">
        <h2 className="text-4xl font-bold font-bebas text-[#e6eaed] mb-12">Open Positions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {positions.map((position, idx) => (
            <motion.div
              key={position.id}
              className="p-6 border border-[#8c0415] hover:border-[#bf0614] bg-black/50 group transition-all duration-300"
              whileHover={{ y: -5 }}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h3 className="text-xl font-bold font-bebas text-[#e6eaed] group-hover:text-[#bf0614] transition-colors">
                    {position.title}
                  </h3>
                  <p className="text-sm text-[#bf0614] uppercase tracking-widest">{position.department}</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                <span className="text-xs px-3 py-1 border border-[#8c0415] text-[#e6eaed]/70">
                  {position.type}
                </span>
                <span className="text-xs px-3 py-1 border border-[#8c0415] text-[#e6eaed]/70">
                  {position.experience}
              ...
              <a
                href="/contact"
                className="inline-block text-[#bf0614] font-bold text-sm uppercase tracking-widest hover:text-[#ff1a2e] transition-colors"
              >
                Apply Now →
              </a>
            </motion.div>
      ...
      {/* Culture Section */}
      <div className="container-custom py-16">
        <div className="p-12 border border-[#8c0415] bg-[rgba(140,4,21,0.1)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h4 className="font-bold text-[#bf0614] mb-2">Excellence</h4>
              <p className="text-[#e6eaed]/70 text-sm">
                We strive for the highest standards in every project and interaction.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-[#bf0614] mb-2">Safety First</h4>
              <p className="text-[#e6eaed]/70 text-sm">
                Our employees' wellbeing is our top priority in all operations.
              </p>
            </div>
            <div>
              <h4 className="font-bold text-[#bf0614] mb-2">Collaboration</h4>
              <p className="text-[#e6eaed]/70 text-sm">
      ...
      <div className="container-custom py-16">
        <div className="p-12 border-2 border-[#bf0614] bg-gradient-to-r from-[rgba(140,4,21,0.2)] to-[rgba(140,4,21,0.05)] text-center">
          ...
          <p className="text-[#e6eaed]/70 mb-8">
