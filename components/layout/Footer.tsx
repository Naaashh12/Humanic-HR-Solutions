    ...
    <footer className="relative bg-black overflow-hidden">
      ...
      >
        ...
        <g filter="url(#gearGlow)">
          <Gear cx={80} cy={440} r={88} ir={66} teeth={16} strokeColor="#ff1a2e" opacity={1} animDur="20s" animDir={1} strokeWidth={1.8} />
        </g>
        {/* Medium meshing gear */}
        <g filter="url(#gearGlowMed)">
          <Gear cx={230} cy={400} r={50} ir={36} teeth={10} strokeColor="#bf0614" opacity={1} animDur="11.5s" animDir={-1} strokeWidth={1.5} />
        </g>
        {/* Small gear top of cluster */}
        <g filter="url(#gearGlowSoft)">
          <Gear cx={158} cy={318} r={30} ir={21} teeth={7} strokeColor="#ff1a2e" opacity={1} animDur="6.5s" animDir={1} strokeWidth={1.2} />
        </g>
        {/* Tiny accent gear */}
        <g filter="url(#gearGlowSoft)">
          <Gear cx={290} cy={470} r={18} ir={12} teeth={6} strokeColor="#bf0614" opacity={1} animDur="5s" animDir={1} strokeWidth={1} />
        </g>
        {/* Extra medium — left mid */}
        <g filter="url(#gearGlowMed)">
          <Gear cx={50} cy={280} r={38} ir={27} teeth={9} strokeColor="#8c0415" opacity={1} animDur="13s" animDir={-1} strokeWidth={1.3} />
        </g>

        {/* ════ TOP-RIGHT CLUSTER ════ */}
        {/* XL anchor gear */}
        <g filter="url(#gearGlow)">
          <Gear cx={1370} cy={150} r={96} ir={72} teeth={18} strokeColor="#ff1a2e" opacity={1} animDur="24s" animDir={-1} strokeWidth={1.8} />
        </g>
        {/* Medium meshing gear */}
        <g filter="url(#gearGlowMed)">
          <Gear cx={1212} cy={185} r={54} ir={39} teeth={11} strokeColor="#bf0614" opacity={1} animDur="13s" animDir={1} strokeWidth={1.5} />
        </g>
        {/* Small gear */}
        <g filter="url(#gearGlowSoft)">
          <Gear cx={1298} cy={278} r={32} ir={22} teeth={8} strokeColor="#ff1a2e" opacity={1} animDur="7.5s" animDir={-1} strokeWidth={1.2} />
        </g>
        {/* Tiny accent gear */}
        <g filter="url(#gearGlowSoft)">
          <Gear cx={1150} cy={110} r={20} ir={14} teeth={6} strokeColor="#bf0614" opacity={1} animDur="5.5s" animDir={1} strokeWidth={1} />
        </g>
        {/* Extra medium — right edge */}
        <g filter="url(#gearGlowMed)">
          <Gear cx={1410} cy={300} r={42} ir={30} teeth={9} strokeColor="#8c0415" opacity={1} animDur="15s" animDir={1} strokeWidth={1.3} />
        </g>

        {/* ════ SCATTERED LONE GEARS ════ */}
        <g filter="url(#gearGlowMed)">
          <Gear cx={680} cy={200} r={40} ir={28} teeth={9} strokeColor="#8c0415" opacity={1} animDur="16s" animDir={1} strokeWidth={1.2} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={500} cy={420} r={28} ir={19} teeth={7} strokeColor="#bf0614" opacity={1} animDur="10s" animDir={-1} strokeWidth={1.1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={900} cy={380} r={36} ir={25} teeth={8} strokeColor="#ff1a2e" opacity={1} animDur="12s" animDir={1} strokeWidth={1.1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={1050} cy={460} r={24} ir={16} teeth={6} strokeColor="#8c0415" opacity={1} animDur="8s" animDir={-1} strokeWidth={1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={360} cy={200} r={26} ir={18} teeth={7} strokeColor="#bf0614" opacity={1} animDur="9s" animDir={1} strokeWidth={1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={780} cy={460} r={22} ir={15} teeth={6} strokeColor="#8c0415" opacity={1} animDur="11s" animDir={-1} strokeWidth={1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={1100} cy={260} r={30} ir={21} teeth={8} strokeColor="#bf0614" opacity={1} animDur="14s" animDir={1} strokeWidth={1.1} />
        </g>
        <g filter="url(#gearGlowSoft)">
          <Gear cx={580} cy={310} r={20} ir={14} teeth={6} strokeColor="#ff1a2e" opacity={1} animDur="7s" animDir={1} strokeWidth={1} />
        </g>

        {/* ════ HEXAGONS ════ */}
        <Hex cx={500} cy={120} r={38} strokeColor="#bf0614" opacity={1} animDur="22s" delay="0s" />
        <Hex cx={496} cy={120} r={24} strokeColor="#ff1a2e" opacity={0.85} animDur="14s" delay="2s" />
        <Hex cx={700} cy={360} r={32} strokeColor="#8c0415" opacity={0.9} animDur="28s" delay="1s" />
        <Hex cx={900} cy={140} r={44} strokeColor="#bf0614" opacity={0.85} animDur="26s" delay="3s" />
        <Hex cx={896} cy={140} r={27} strokeColor="#ff1a2e" opacity={0.75} animDur="16s" delay="5s" />
        <Hex cx={200} cy={200} r={34} strokeColor="#8c0415" opacity={0.9} animDur="19s" delay="4s" />
        <Hex cx={1180} cy={430} r={36} strokeColor="#bf0614" opacity={0.85} animDur="24s" delay="2s" />
        <Hex cx={620} cy={250} r={22} strokeColor="#ff1a2e" opacity={0.8} animDur="15s" delay="1s" />
        <Hex cx={420} cy={480} r={28} strokeColor="#8c0415" opacity={0.75} animDur="21s" delay="3s" />
        <Hex cx={1300} cy={400} r={30} strokeColor="#bf0614" opacity={0.7} animDur="18s" delay="1.5s" />

        {/* ════ ROTATING TRIANGLES ════ */}
        {[
          { cx: 400, cy: 320, r: 24, dur: '11s', op: 0.75, col: '#bf0614' },
          { cx: 800, cy: 210, r: 18, dur: '8s',  op: 0.7,  col: '#ff1a2e' },
          { cx: 1050, cy: 450, r: 28, dur: '14s', op: 0.65, col: '#8c0415' },
          { cx: 260, cy: 370, r: 16, dur: '10s', op: 0.7,  col: '#bf0614' },
          { cx: 660, cy: 430, r: 20, dur: '13s', op: 0.6,  col: '#ff1a2e' },
          { cx: 950, cy: 260, r: 15, dur: '9s',  op: 0.65, col: '#8c0415' },
          { cx: 1200, cy: 330, r: 22, dur: '12s', op: 0.6,  col: '#bf0614' },
        ...
        >
          <defs>
            <radialGradient id="starBurst" cx="85%" cy="10%" r="25%">
              ...
              <stop offset="12%" stopColor="#ffaaaa" stopOpacity="0.75" />
              <stop offset="35%" stopColor="#bf0614" stopOpacity="0.4" />
              <stop offset="100%" stopColor="#bf0614" stopOpacity="0" />
            </radialGradient>
            <linearGradient id="rimGrad" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="transparent" />
              <stop offset="12%" stopColor="#8c0415" />
              <stop offset="42%" stopColor="#bf0614" />
              <stop offset="78%" stopColor="#ff4455" />
              <stop offset="86%" stopColor="#ff1a2e" />
              <stop offset="91%" stopColor="#ff4455" />
              <stop offset="100%" stopColor="#8c0415" />
            </linearGradient>
            <linearGradient id="haloGrad" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="transparent" />
              <stop offset="18%" stopColor="#bf0614" stopOpacity="0.18" />
              <stop offset="78%" stopColor="#bf0614" stopOpacity="0.38" />
              <stop offset="86%" stopColor="#ff1a2e" stopOpacity="0.55" />
          ...
          <circle cx="85%" cy="3" r="3.5" fill="white" opacity="0.98">
            <animate attributeName="opacity" values="0.98;0.45;0.98" dur="2.5s" repeatCount="indefinite" />
            <animate attributeName="r" values="3.5;5.5;3.5" dur="2.5s" repeatCount="indefinite" />
          </circle>
          {/* Ripple ring */}
          <circle cx="85%" cy="3" r="12" fill="none" stroke="rgba(255,255,255,0.25)" strokeWidth="1">
      ...
      <div className="relative z-10 container-custom pt-32 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-start gap-3 text-[#e6eaed]/70 hover:text-[#bf0614] transition-colors">
                <MapPin className="w-4 h-4 text-[#bf0614] shrink-0 mt-0.5" />
                <span>{COMPANY_LOCATION}</span>
              </div>
              <div className="flex items-center gap-3 text-[#e6eaed]/70 hover:text-[#bf0614] transition-colors">
                <Phone className="w-4 h-4 text-[#bf0614] shrink-0" />
                <a href={`tel:${COMPANY_PHONE}`}>{COMPANY_PHONE}</a>
              </div>
              <div className="flex items-center gap-3 text-[#e6eaed]/70 hover:text-[#bf0614] transition-colors">
                <Mail className="w-4 h-4 text-[#bf0614] shrink-0" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              {FOOTER_SECTIONS.company.links.map((link, i) => (
                <li key={i}>
                  <a href={link.href} className="text-[#e6eaed]/70 hover:text-[#bf0614] transition-colors text-sm flex items-center gap-2 group">
                    <span className="text-[#8c0415] opacity-0 group-hover:opacity-100 transition-all shrink-0">▸</span>
                    {link.label}
                  </a>
                </li>
              ))}
              ...
              {servicesA.map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="text-[#e6eaed]/70 hover:text-[#bf0614] transition-colors text-xs flex items-center gap-2 group leading-snug"
                  >
                    <span className="text-[#8c0415] opacity-0 group-hover:opacity-100 transition-all shrink-0">▸</span>
                    {service.title}
                  </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-center md:text-left space-y-1">
            <p className="text-sm text-[#e6eaed]/60">&copy; {currentYear} {COMPANY_NAME}. All rights reserved.</p>
            <p className="text-sm">
              ...
              <a
                ...
                className="relative inline-block text-[#bf0614] hover:text-[#ff1a2e] transition-colors font-bold tracking-wide group text-base"
              >
                darknebulabs.online
                <span className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-gradient-to-r from-[#bf0614] to-[#ff1a2e] group-hover:w-full transition-all duration-350" />
              </a>
            </p>
          </div>
            ...
            {SOCIAL_LINKS.map((social) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[#8c0415] hover:text-[#bf0614] transition-all duration-300 hover:scale-125"
